...
export default async function DashboardPage() {
  ...
  const [homes, apartmentMemberships, management] = await Promise.all([listHomes(session.user.id), listUserApartmentMemberships(session.user.id), dashboardManagement(session.user.id)]);
  return (
